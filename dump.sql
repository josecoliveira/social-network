...
--
-- Name: photos_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
COPY public.photos (album_id, id, title, url, thumbnail_url) FROM stdin;
1	1	Photo title 1	url	url
2	2	Photo title 2	url	url
\.
...
--
-- Name: photos_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: photos photos_album_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: root
--

ALTER TABLE ONLY public.photos
    ADD CONSTRAINT photos_album_id_fkey FOREIGN KEY (album_id) REFERENCES public.albums(id) ON UPDATE CASCADE ON DELETE CASCADE;
